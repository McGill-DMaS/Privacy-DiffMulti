...
//#define _TD_SCORE_FUNTION_DISCERNIBILITY	// Change the name file below to _TD_NAME_FILE_NORMAL
//#define _TD_SCORE_FUNCTION_NCP			// Change the name file below to _TD_NAME_FILE_NORMAL


// Name file
//#define _TD_NAME_FILE_NORMAL			// Original attributes with generalized domain values.
										// Activate for _TD_SCORE_FUNTION_DISCERNIBILITY and _TD_SCORE_FUNCTION_NCP.
#define _TD_NAME_FILE_MULTIDIM			// Any generalized concept is considered an attribute with domain values = {0, 1}, except numerical attributes.
										...
										// Activate for clustering and classification (_TD_SCORE_FUNCTION_INFOGAIN or _TD_SCORE_FUNTION_MAX).

// Target workload
// 1) Classifier type: C.45 or SVM-light
#define TD_bC45								0	// Insert a boolean value. 1 for C.45, 0 for SVM data format.
												// Used only when _TD_NAME_FILE_MULTIDIM.

// 2) Clustering (vcluster.exe format)
#define TD_bCluster							1
